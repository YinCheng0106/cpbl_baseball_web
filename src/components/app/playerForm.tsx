...
import { PlayerCreatedCard } from "@/components/app/playerCreatedCard";

const PlayerSchema = z.object({
  id: z.coerce.number().min(1, "請輸入球員ID"),
  domestic: z.boolean(),
  ...
  draftYear: z.coerce.number().optional(),
  draftRound: z.coerce.number().optional(),
  number: z.coerce.number().min(1, "請輸入球員號碼"),
  ...
  height: z.coerce.number().min(1, "請輸入球員身高"),
  weight: z.coerce.number().min(1, "請輸入球員體重"),
