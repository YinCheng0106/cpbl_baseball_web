        ...
        { mvp.playerType === "打者" ? (
          <div className="flex flex-col gap-1">
            ...
            <div className="flex justify-between border-b pb-1">
              ...
              <span className="text-sm">{mvp.gameStatus.hit.hitCnt}</span>
            </div>
            <div className="flex justify-between border-b pb-1">
              <span className="text-sm font-medium">打點</span>
              <span className="text-sm">{mvp.gameStatus.hit.runBattedInCnt}</span>
            </div>
            <div className="flex justify-between border-b pb-1">
              <span className="text-sm font-medium">得分</span>
              <span className="text-sm">{mvp.gameStatus.hit.scoreCnt}</span>
            </div>
            <div className="flex justify-between border-b pb-1">
              <span className="text-sm font-medium">全壘打</span>
              <span className="text-sm">{mvp.gameStatus.hit.homeRunCnt}</span>
            </div>
          </div>
        ):(
          <div className="flex flex-col gap-1">
            ...
            <div className="flex justify-between border-b pb-1">
              ...
              <span className="text-sm">{mvp.gameStatus.pitch.inningPitchedCnt}</span>
            </div>
            <div className="flex justify-between border-b pb-1">
              <span className="text-sm font-medium">奪三振數</span>
              <span className="text-sm">{mvp.gameStatus.pitch.strikeOutCnt}</span>
            </div>
            <div className="flex justify-between border-b pb-1">
              <span className="text-sm font-medium">失分數</span>
              <span className="text-sm">{mvp.gameStatus.pitch.runCnt}</span>
            </div>
          </div>
        ) }
      </div>
